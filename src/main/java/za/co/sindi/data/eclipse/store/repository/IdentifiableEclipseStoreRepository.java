 ...
 * 
 */
package za.co.sindi.data.eclipse.store.repository;
 ...
 */
public abstract class IdentifiableEclipseStoreRepository<E extends IdentifiableEntity<ID>, ID extends Comparable<ID> & Serializable> extends AbstractEclipseStoreRepository<E, ID> {
